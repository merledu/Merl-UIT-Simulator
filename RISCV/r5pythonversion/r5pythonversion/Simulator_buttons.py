...
def execute(whole_code):
    ...
    while views.Base.vari < len(views.Base.code_line1):            #
    #for i in range(views.Base.vari, len(views.Base.code_line1)):
        ...
        '''if views.Base.vari == len(code_line):
            break'''
        x = views.Base.code_line1[views.Base.vari]
        x = x.lower()
        x = x.strip()
        ...
        #     x = i_type[count_i].getoperatori(x)
        #     # i_type[count_i].getsdi(x)
        #     x = views.Base.data[views.Base.vari][0]
        #     i_type[count_i].dest = views.Base.data[views.Base.vari][1]
        #     i_type[count_i].src1 = views.Base.data[views.Base.vari][2]
        #     i_type[count_i].src2 = views.Base.data[views.Base.vari][3]
    ...
    #SW for C extension
            ...
            print(code_line)
            jump_type.append(UJ_type.JumpIns(x, views.Base.vari, code_line, whole_code, views.Base.label_address))
            ...
            if 'jalr' in x:
                ...
                # vari = track + 1
                print("vari after jalr", views.Base.vari)
                count_jump += 1
            elif 'jal' in x:
                y = x[4:]
